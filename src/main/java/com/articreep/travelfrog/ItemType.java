...
public enum ItemType {
    ...
    KONPEITO_PURPLE(Material.SUGAR, -1, false, ItemCategory.FOOD,
            Component.text("Konpeito (purple)", NamedTextColor.LIGHT_PURPLE).decoration(TextDecoration.ITALIC, false),
    ...
    CRACKERS_PURPLE(Material.COOKIE, -1, false, ItemCategory.FOOD,
            Component.text("Crackers (purple)", NamedTextColor.LIGHT_PURPLE).decoration(TextDecoration.ITALIC, false),
            Component.text("Just some crackers!", NamedTextColor.GRAY)),
